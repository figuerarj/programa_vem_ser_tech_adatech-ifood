...
const Login = () => {
    ...
    axios.get("http://localhost:3000/users")
      .then(result => {
        ...
        if (Array.isArray(result.data)) {
          // Realiza a lógica apenas se result.data for uma matriz
  ...
  return (
    ...
    <div className='form-group'>
      ...
      <p className='text-center'>If you don´t have an account, Please 
     <Link to="/subscribe"> <span>Subscribe Now!</span></Link>
    </p>
    </div>
